...
import { CloudflareApiError, handleApiError } from "alchemy/cloudflare";
import { applyMigrations, listFiles } from "./d1-migrations";
...
export async function D1Database(
  ...
  const migrationsFiles = props.migrationsDir
    ? await listFiles(props.migrationsDir)
    : [];
...
export const D1DatabaseResource = Resource(
  "cloudflare::D1DatabaseWithMigrations",
  async function (
